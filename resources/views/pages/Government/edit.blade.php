...
@section('PageContent')
    ...
    <div class="row">
        <div class="col-8 mx-auto mt-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('government.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingNumberInput" name="code"
                                value="{{ old('code', $data->code) }}" placeholder="@lang('code')" />
                            <label for="floatingNumberInput">@lang('code')</label>
                            @error('code')
                                <span style="color:red;">
                                    {{ $errors->first('code') }}
                                </span>
